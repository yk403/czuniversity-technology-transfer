...
import com.itts.common.bean.ColumnDO;
import com.itts.common.bean.TableDO;
import com.itts.common.config.Constant;
...
public class GenUtils {
    ...
    private final static String BASE_URL = "static/generator/";

    public static List<String> getTemplates() {
        List<String> templates = new ArrayList<String>();
        templates.add(BASE_URL + "entity.java.vm");
        templates.add(BASE_URL + "Mapper.java.vm");
        templates.add(BASE_URL + "Mapper.xml.vm");
        templates.add(BASE_URL + "Service.java.vm");
        templates.add(BASE_URL + "ServiceImpl.java.vm");
        templates.add(BASE_URL + "Controller.java.vm");
        templates.add(BASE_URL + "index.vue.vm");
        templates.add(BASE_URL + "index.js.vm");
        templates.add(BASE_URL + "add.vue.vm");
        return templates;
    }
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        tableDO.setClassname(org.apache.commons.lang3.StringUtils.uncapitalize(className));
        ...
        for (Map<String, String> column : columns) {
            ...
            columnDO.setAttrname(org.apache.commons.lang3.StringUtils.uncapitalize(attrName));
