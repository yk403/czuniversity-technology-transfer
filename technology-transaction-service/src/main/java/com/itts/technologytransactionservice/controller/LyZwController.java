...
//return null;
        return ResponseUtil.success(lyZwService.findLyZwFront(params));
    }
    //    *
//     * 获取复选框列表
...
//return null;
        return ResponseUtil.success(lyZwService.findLyZwFrontSelect(params));
    }
//    *
//     * 根据ID查询
//     * @param id
//     * @return
    ...
    public ResponseUtil getById(@PathVariable("id") Long id) {
        return ResponseUtil.success(lyZwService.getById(id));
    }
//    *
//     * 保存
    ...
    public ResponseUtil update(@RequestBody LyZw lyZw) throws WebException {
        ...
        //检查数据库中是否存在要更新的数据
        if (lyZwService.getById(id) == null) {
            throw new WebException(SYSTEM_NOT_FIND_ERROR);
        }
        //更新数据
        if (!lyZwService.updateById(lyZw)) {
    ...
    public ResponseUtil delete(@PathVariable("id") Long id) {
        ...
        LyZw old = lyZwService.getById(id);
        if (old == null) {
