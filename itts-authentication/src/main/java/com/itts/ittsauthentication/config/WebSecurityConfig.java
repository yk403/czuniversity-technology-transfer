...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            "/v2/api-docs", "/v3/api-docs", "/webjars/**", "/admin/api/v1/spzb/callback/","/api/uncheck/v1/**",
            ...
            ,"/api/v1/pc/getByDictionary", "/api/v1/gngl/**", "/api/v1/jggl/get/by/code/", "/admin/api/v1/jggl/find/base/list/**",
            "/api/v1/**", "/admin/api/v1/sz/getByJgBh", "/admin/api/v1/jggl/get/by/code/"
    };
