 ...
 */
@Data
@ApiModel(value = "增加题库资源")
public class AddTkzyRequest implements Serializable {

    private static final long serialVersionUID = 6911630180641893391L;
    ...
    private List<AddTmxxRequest> tmxxs;
