...
public interface XsMapper extends BaseMapper<Xs> {
     ...
     * @return
     */
    List<StuDTO> findXsList(@Param("pcId") Long pcId, @Param("xslbmc") String xslbmc, @Param("jyxs") String jyxs, @Param("name") String name,@Param("qydsId") Long qydsId,@Param("yzydsId") Long yzydsId,@Param("fjjgId") Long fjjgId);
