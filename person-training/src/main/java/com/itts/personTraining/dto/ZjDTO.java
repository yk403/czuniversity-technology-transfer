...
public class ZjDTO implements Serializable {
     ...
     * 类型(校内; 校外)
     */
    @ExcelProperty(value = "类型(校内; 校外)", index = 7)
    private String lx;

    /**
     * 专业技术职位
     */
    @ExcelProperty(value = "专业技术职位", index = 8)
     ...
     * 座机号
     */
    @ExcelProperty(value = "座机号", index = 12)
    private String zjh;
     ...
     * 从事学科
     */
    @ExcelProperty(value = "从事学科", index = 14)
    private String csxk;

    /**
     * 专长方向
     */
    @ExcelProperty(value = "专长方向", index = 15)
    private String zcfx;

    /**
     * 研究成果
     */
    @ExcelProperty(value = "研究成果", index = 16)
    private String yjcg;

    /**
     * 电子邮件
     */
    @ExcelProperty(value = "电子邮件", index = 17)
    private String dzyj;

    /**
     * 研究领域
     */
    @ExcelProperty(value = "研究领域", index = 18)
    private String yjly;

    /**
     * 知识产权
     */
    @ExcelProperty(value = "知识产权", index = 19)
    private String zscq;

    /**
     * 在建项目
     */
    @ExcelProperty(value = "在建项目", index = 20)
    private String zjxm;

    /**
     * 论文
     */
    @ExcelProperty(value = "论文", index = 21)
    private String lw;

    /**
     * 专利号
     */
    @ExcelProperty(value = "专利号", index = 22)
    private String zlh;
