package com.itts.userservice.common.quartz.utils;

import com.itts.userservice.common.quartz.thread.ThreadPoolExecutorUtil;
...
public class ExecutionJob extends QuartzJobBean {
    ...
    @Autowired
    QuartzLogMapper quartzLogRepository;
    @Autowired
...
//        IQuartzJobService quartzJobService = SpringContextHolder.getBean(IQuartzJobService.class);
        ...
        try {
            ...
            log.setExceptionDetail(ThrowableUtil.stackTraceToString(e));
